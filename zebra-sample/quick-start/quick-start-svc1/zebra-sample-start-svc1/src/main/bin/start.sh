...
WORKDIR=$(dirname "$PWD")
JARFILE=$WORKDIR/zebra-sample-start-svc1.jar
CONF=$WORKDIR/config
...
java -Xmx4G -Xms4G -Xmn2G -Xss1m -XX:+UseParallelGC -XX:+UseParallelOldGC -Dapplication=zebra-sample-start-svc1 -classpath $CLASSPATH com.guosen.App $start_cmd
