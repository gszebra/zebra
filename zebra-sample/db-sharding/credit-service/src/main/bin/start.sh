...
WORKDIR=$(dirname "$PWD")
JARFILE=$WORKDIR/credit-service.jar
CONF=$WORKDIR/config
...
java -Xmx4G -Xms4G -Xmn2G -Xss1m -XX:+UseParallelGC -XX:+UseParallelOldGC -Dapplication=credit-service -classpath $CLASSPATH com.guosen.App $start_cmd
