...
import org.mybatis.zebra.util.BatchInsertUtil;
  ...
  private class SqlSessionInterceptor implements InvocationHandler {
    ...
    public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
      ...
      if (!BatchInsertUtil.isBatchInsertMethod(mapperFullMethodName)) {
        ...
        return doZebraBatchInsert(proxy, method, args);
      }
    }
     ...
     * zebra定制的批量插入代码
     */
    private int doZebraBatchInsert(Object proxy, Method method, Object[] args) throws Throwable {
