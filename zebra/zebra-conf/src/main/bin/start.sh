...
WORKDIR=$(dirname "$PWD")
JARFILE=$WORKDIR/zebra-conf.jar
CONF=$WORKDIR/config
...
java -Xmx4G -Xms4G -Xmn2G -Xss1m -XX:+UseParallelGC -XX:+UseParallelOldGC -Dapplication=zebra-conf -classpath $CLASSPATH com.guosen.App $start_cmd
