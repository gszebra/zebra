...
public class RpcErrorMsgConstant {
	...
	public static final RpcErrorMsg SERVICE_DEFAULT_ERROR = new RpcErrorMsg(503, SERVICE_DEFAULT_ERROR_CODE,
			"service error");
	public static final RpcErrorMsg SERVICE_REJECT = new RpcErrorMsg(503, SERVICE_REJECT_ERROR_CODE, "service reject");
	public static final RpcErrorMsg SERVICE_UNFOUND = new RpcErrorMsg(404, SERVICE_UNFOUND_ERROR_CODE,
			"service unfound");
	public static final RpcErrorMsg SERVICE_TIMEOUT = new RpcErrorMsg(503, SERVICE_TIMEOUT_ERROR_CODE,
			"service request timeout");
	public static final RpcErrorMsg SERVICE_TASK_CANCEL = new RpcErrorMsg(503, SERVICE_TASK_CANCEL_ERROR_CODE,
			"service task cancel");
	...
	/** service error end **/
	public static final RpcErrorMsg FRAMEWORK_ENCODE_ERROR = new RpcErrorMsg(503, FRAMEWORK_ENCODE_ERROR_CODE,
			"framework encode error");
	public static final RpcErrorMsg FRAMEWORK_DECODE_ERROR = new RpcErrorMsg(503, FRAMEWORK_DECODE_ERROR_CODE,
			"framework decode error");
	public static final RpcErrorMsg FRAMEWORK_INIT_ERROR = new RpcErrorMsg(500, FRAMEWORK_INIT_ERROR_CODE,
			"framework init error");
	public static final RpcErrorMsg FRAMEWORK_EXPORT_ERROR = new RpcErrorMsg(503, FRAMEWORK_EXPORT_ERROR_CODE,
			"framework export error");
	public static final RpcErrorMsg FRAMEWORK_REFER_ERROR = new RpcErrorMsg(503, FRAMEWORK_REFER_ERROR_CODE,
			"framework refer error");
	
	public static final RpcErrorMsg FRAMEWORK_ETCD_ERROR = new RpcErrorMsg(503, FRAMEWORK_REGISTER_ERROR_CODE,
			"connet etcd error");
	/**
	 * biz error start
	 **/
	public static final RpcErrorMsg BIZ_DEFAULT_EXCEPTION = new RpcErrorMsg(503, BIZ_DEFAULT_ERROR_CODE,
			"provider error");
	/**
	 * validate error
	 **/
	public static final RpcErrorMsg REQUEST_ARG_VALIDATE_EXCEPTION = new RpcErrorMsg(503, BIZ_VALIDATE_ERROR_CODE,

			"request arg validate error");

	public static final RpcErrorMsg PROPERTIES_NOT_EXISTS_EXCEPTION = new RpcErrorMsg(503, BIZ_DEFAULT_ERROR_CODE,
