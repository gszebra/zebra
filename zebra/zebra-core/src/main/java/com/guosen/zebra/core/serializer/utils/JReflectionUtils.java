...
public class JReflectionUtils {
    ...
    public static Object runMethod(Object object, Method method, Object... args) throws JException {
        try {
     ...
     * 执行静态方法
     */
    public static Object runStaticMethod(Class<?> clzz, String method) throws JException {
        try {
            Method m=clzz.getMethod(method);;
