...
WORKDIR=$(dirname "$PWD")
JARFILE=$WORKDIR/zebra-console.jar
CONF=$WORKDIR/config
...
java -Xmx4G -Xms4G -Xmn2G -Xss1m -XX:+UseParallelGC -XX:+UseParallelOldGC -Dapplication=zebra-console -classpath $CLASSPATH com.guosen.App $start_cmd
